...
const scamTypes = [
  { name: 'Investment scams',    amount: '$1.3B', pct: 100 },
  { name: 'Remote access scams', amount: '$256M', pct: 20  },
  { name: 'Payment redirection', amount: '$224M', pct: 17  },
  { name: 'Romance scams',       amount: '$40M',  pct: 3   },
  { name: 'Phishing',            amount: '$29M',  pct: 2   },
]
...
const features = [
  ...
  },
  {
    page: 'tnc-simplifier',
    icon: 'doc',
    title: 'Understand Terms & Conditions',
    desc: 'Confused by the fine print before signing up to something? We translate legal language into plain English.',
...
<template>
  ...
  >
    ...
    <!-- Item 1: left-only padding so illustration can bleed to the right edge -->
    <div class="relative pl-6 sm:pl-12 pr-4 py-16 sm:py-24">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <!-- Right: warm illustration — visible from lg up -->
  ...
  <section class="py-16 sm:py-20 px-4" style="background-color: var(--bg);">
    ...
    <!-- Item 5: cursor-pointer is applied globally via main.css button rule -->
  ...
  <!-- ============================================================
       WHO IS THIS FOR — Item 4: illustration alongside scenario tiles
       ============================================================ -->
  <section class="py-16 px-4 bg-white">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">

      <!-- Left: senior lady illustration + scenario tiles -->
      <div class="animate-fade-in-up">

        <!-- Item 4: senior lady illustration near scenario tiles -->
  ...
  <!-- ============================================================
       SCAM STATISTICS — Data Visualisation
       ============================================================ -->
  <section class="py-16 px-4" style="background-color: var(--bg);">
    ...
    <div class="text-center mb-10 animate-fade-in-up">
      ...
      <p class="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
        ...
        Knowing what to look for is your best defence.
      </p>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">

      <!-- Bar chart: top scam types by loss -->
      <div class="bg-white rounded-2xl p-7 border border-slate-200 shadow-sm animate-fade-in-up">
        <p class="text-xl font-bold text-slate-900 mb-6">Top scam types by financial loss (2023)</p>
        <div class="space-y-5">
          <div v-for="type in scamTypes" :key="type.name">
            ...
            <div class="w-full bg-slate-100 rounded-full h-4">
              <div
                ...
                :style="{ width: type.pct + '%', backgroundColor: 'var(--navy)' }"
              ></div>
            </div>
          </div>
        </div>
        <p class="text-sm text-slate-500 mt-6">Source: ACCC Scamwatch 2023 Annual Report</p>
      </div>

      <!-- Age group breakdown -->
      <div class="space-y-5">
        <div class="bg-white rounded-2xl p-7 border border-slate-200 shadow-sm animate-fade-in-up stagger-1">
          <p class="text-xl font-bold text-slate-900 mb-6">Who is most affected by scams?</p>
          <div class="space-y-4">
            <div v-for="(age, i) in ageGroups" :key="age.group" class="flex items-center gap-4">
              ...
              <div class="flex-1 bg-slate-100 rounded-full h-5">
                <div
                  class="h-5 rounded-full"
                  :style="{
                    width: age.pct + '%',
                    backgroundColor: `rgba(30,58,138,${1 - i * 0.16})`
                  }"
                ></div>
              </div>
          ...
          <p class="text-sm text-slate-500 mt-5">Relative vulnerability index — 65+ face the highest risk per person</p>
        </div>

        <div class="rounded-2xl p-6 shadow-sm bg-white animate-fade-in-up stagger-2"
          style="border-left: 4px solid var(--navy); border-top: 1px solid #bfdbfe; border-right: 1px solid #bfdbfe; border-bottom: 1px solid #bfdbfe;">
          <p class="text-lg font-bold text-slate-900 mb-2">Why are older Australians targeted?</p>
          <p class="text-lg text-slate-600 leading-relaxed">
            Scammers specifically target people aged 65+ because they are more likely to have savings,
